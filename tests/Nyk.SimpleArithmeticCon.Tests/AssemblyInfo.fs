...
[<assembly: AssemblyTitleAttribute("Nyk.SimpleArithmeticCon.Tests")>]
[<assembly: AssemblyProductAttribute("Nyk.SimpleArithmeticCon")>]
...
module internal AssemblyVersionInformation =
    let [<Literal>] AssemblyTitle = "Nyk.SimpleArithmeticCon.Tests"
    let [<Literal>] AssemblyProduct = "Nyk.SimpleArithmeticCon"
